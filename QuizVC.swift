...
class QuizVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que1 = Question(imgName: "", questionText: "How many centimeters does a 20 centimeter ruler have?", options: ["10", "20", "30", "40"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "", questionText: "What is the capital of Great Britain", options: ["Ast-Ana", "Qasym-Zhomart", "Nur-Sultan", "London"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "", questionText: "How many days did the Hundred Years War last?", options: ["100", "106", "116", "126"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que4 = Question(imgName: "", questionText: "Which countries are not part of the USSR?", options: ["Kazakhstan", "Armenia", "Latvia", "Mongolia"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que5 = Question(imgName: "", questionText: "The real name of the comedian Saburov", options: ["Nurlan", "Nurali", "Nursultan", "Reptiloid"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que6 = Question(imgName: "", questionText: "What is the name of the main prison for especially dangerous criminals in Kazakhstan?", options: ["Black bear", "Red hawk", "Black eagle", "Snow leopard"], correctAns: 2, wrongAns: -1, isAnswered: false)
